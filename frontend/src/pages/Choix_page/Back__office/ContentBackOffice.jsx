...
import {
  Content_card,
  Card_Service,
} from "../../../Composant/jsx/composant_BackOffice/content_card";
...
function AjoutService() {
  ...
  const handleSubmit = (e) => {
    ...
    formDataObject.append(
      "departement_description",
      formData.departement_description
    );
    ...
    <>
      <form className="from_ajout_service" onSubmit={handleSubmit}>
        <InputPerso
          ...
          type={"texte"}
          name={"name"}
          classN={"inputNomService"}
          labelTexte={"Département"}
          value={formData.name}
        />
        <InputPerso
          fonction={handleChange}
          type={"texte"}
          name={"departement_description"}
          classN={"inputDescription"}
          labelTexte={"Déscription"}
          value={formData.departement_description}
        />
        <InputPerso
          fonction={handleChange}
          type={"texte"}
          name={"departement_icon"}
          classN={"inputIcon"}
          labelTexte={"Icon"}
          value={formData.departement_icon}
        />
    ...
    <>
      <form className="from_demande_offre" onSubmit={handleSubmit}>
        ...
        <InputPerso
          ...
          type={"number"}
          name={"vol_horaire"}
          classN={"inputVolumeHoraire"}
          labelTexte={"Volume horaire"}
          value={formData.vol_horaire}
        />
        <InputPerso
          fonction={handleChange}
          type={"number"}
          name={"vol_homme_jour"}
          classN={"inputHommeJour"}
          labelTexte={"Volume hommme/jour"}
          value={formData.vol_homme_jour}
        />
        <InputPerso
          fonction={handleChange}
          type={"number"}
          name={"vol_tache"}
          classN={"inputVolTache"}
          labelTexte={"Volume tache"}
          value={formData.vol_tache}
        />
        <TextAreaPerso
          fonction={handleChange}
          name={"taches"}
    ...
    <>
      ...
      {cardData.map((data, index) =>
        data.nom == "Tous" ? (
          ...
          <Card1
            key={index}
            poste={data.details.poste}
            departement={data.departement.nom}
            description={data.details.taches}
          />
        )
      )}
    </>
...
export function ContentBackOffice({
  items,
  headerElement,
  items_service,
  items_annonce,
...
export function ContentDepartement({
  headerElement,
  numPage,
  dataDemande,
  idD,
